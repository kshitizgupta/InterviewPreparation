...
/**
 * Brute force approach is to find all contiguous sub-com.arrays. Now record all the sub-com.arrays with
 * sum 0 and find the max length out of all these sub-com.arrays.
